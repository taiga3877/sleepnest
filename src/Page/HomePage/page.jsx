  ...
  return (
    <div>
      <div className='max-w-screen-xl w-full mx-auto m-auto px-4'>
        ...
        <br />
        <div
  className="w-full max-w-[1440px] h-[590px] rounded-3xl transition-all duration-1000 flex items-center justify-between px-10 md:px-16 lg:px-24 overflow-hidden"
...
>
  ...
  <div className="w-1/2 text-right space-y-2">
    <h3 className="text-[#8E6E3D] text-xl md:text-2xl font-semibold tracking-wide">
      Environmental
    </h3>
    <h2 className="text-[#D4B97E] text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
      Clean Sleep
    </h2>
    <h1 className="text-[#B09A60] text-6xl md:text-7xl lg:text-8xl font-extrabold leading-none">
      Products
    </h1>
  </div>
</div>
